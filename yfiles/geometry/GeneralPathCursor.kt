 ...
 */
external  class GeneralPathCursor 
 ...
 */
 final   fun getCurrent( coordinates: ReadonlyArray<Double> ):PathType
/**
 * Places the current end coordinates of the last path element into the array.
 * @param [coordinates] An array with length at least 2.
 ...
 */
 final   fun getCurrentEndPoint( coordinates: ReadonlyArray<Double> ):PathType
/**
 ...
 */
 final   fun movePrevious():Boolean
/**
