...
external interface IMutablePoint : IPoint {
  ...
  /**
   * Sets the [x][IMutablePoint] and [y][IMutablePoint] values of this instance to the given values.
   * @param [location] The new location.
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IMutablePoint%23IMutablePoint-defaultmethod-setLocation(IPoint)">Online Documentation</a>
   */
   ...
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IMutablePoint%23IMutablePoint-defaultmethod-setLocation(number,number)">Online Documentation</a>
   */
  final fun setLocation(
    x: Double,
    y: Double,
