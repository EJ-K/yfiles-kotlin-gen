...
external interface IMutableSize : ISize {
   ...
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IMutableSize%23IMutableSize-defaultmethod-setSize(ISize)">Online Documentation</a>
   */
  final fun setSize(
    newSize: ISize,
   ...
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IMutableSize%23IMutableSize-defaultmethod-setSize(number,number)">Online Documentation</a>
   */
  final fun setSize(
    newWidth: Double,
    newHeight: Double,
