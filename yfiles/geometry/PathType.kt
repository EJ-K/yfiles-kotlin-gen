 ...
 */
external sealed class PathType: YEnum<PathType> {
   companion object: EnumMetadata<PathType> {
       /**
 * The type that is used to move the [Stroke][yfiles.view.Stroke] to the next position.
 * 
 * Value - `0`
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/PathType%23MOVE_TO">Online Documentation</a>
 */
val MOVE_TO: PathType
