 ...
 */
external open class AdjacencyNodesSource<TDataItem>  (
 ...
 */
 final   fun <TEdgeDataItem, TPredecessorDataItem>addInEdgesSource( edgeDataProvider: Provider<TDataItem, Any> ,
 ...
 */
 final   fun <TEdgeDataItem>addInEdgesSourceToId( edgeDataProvider: Provider<TDataItem, Any> ,
 ...
 */
 final   fun <TEdgeDataItem, TSuccessorDataItem>addOutEdgesSource( edgeDataProvider: Provider<TDataItem, Any> ,
 ...
 */
 final   fun <TEdgeDataItem>addOutEdgesSourceToId( edgeDataProvider: Provider<TDataItem, Any> ,
 ...
 */
 final   fun addPredecessorIds( predecessorIdsProvider: Provider<TDataItem, IEnumerable<Any>> ,
 ...
 */
 final   fun <TPredecessorDataItem>addPredecessorsSource( predecessorsProvider: Provider<TDataItem, Any> ,
 ...
 */
 final   fun addSuccessorIds( successorIdsProvider: Provider<TDataItem, IEnumerable<Any>> ,
 edgeCreator: EdgeCreator<TDataItem> )
/**
 ...
 */
 final   fun <TSuccessorDataItem>addSuccessorsSource( successorsProvider: Provider<TDataItem, Any> ,
 ...
 */
 final   fun <TEdgeDataItem, TPredecessorDataItem>createInEdgesSource( edgeDataProvider: Provider<TDataItem, Any> ,
 sourceDataProvider: Provider<TEdgeDataItem, TPredecessorDataItem> ,
 edgeCreator: EdgeCreator<TEdgeDataItem> ,
 sourceIdProvider: IdProvider<TPredecessorDataItem>?  = definedExternally):AdjacencyNodesSource<TPredecessorDataItem>
/**
 ...
 */
 final   fun <TEdgeDataItem, TSuccessorDataItem>createOutEdgesSource( edgeDataProvider: Provider<TDataItem, Any> ,
 targetDataProvider: Provider<TEdgeDataItem, TSuccessorDataItem> ,
 edgeCreator: EdgeCreator<TEdgeDataItem> ,
 targetIdProvider: IdProvider<TSuccessorDataItem>?  = definedExternally):AdjacencyNodesSource<TSuccessorDataItem>
/**
 ...
 */
 final   fun <TPredecessorDataItem>createPredecessorsSource( predecessorsProvider: Provider<TDataItem, Any> ,
 edgeCreator: EdgeCreator<TDataItem> ,
 idProvider: IdProvider<TPredecessorDataItem>?  = definedExternally):AdjacencyNodesSource<TPredecessorDataItem>
/**
 * Registers a provider for node data items functioning as node objects for the returned [AdjacencyNodesSource].
 * @param [TSuccessorDataItem] The type of the successor data items in the source.
 * @param [successorsProvider] A function that yields the successor data items for each node data item associated with this [AdjacencyNodesSource].
 ...
 */
 final   fun <TSuccessorDataItem>createSuccessorsSource( successorsProvider: Provider<TDataItem, Any> ,
 edgeCreator: EdgeCreator<TDataItem> ,
 idProvider: IdProvider<TSuccessorDataItem>?  = definedExternally):AdjacencyNodesSource<TSuccessorDataItem>
/**
