 ...
 * 
 * @constructor Initializes a new instance using the given renderer.
 * @param [renderer] A custom renderer instance for this style. If none is provided, a new [GroupNodeStyleRenderer] is used.
 ...
 */
external open class GroupNodeStyle  (
final override val renderer: GroupNodeStyleRenderer = definedExternally) : INodeStyle {
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/GroupNodeStyle%23contentAreaInsets">Online Documentation</a>
 */
final var contentAreaInsets: Insets
/**
 ...
 * 
 * The default value is [GroupNodeStyleIconType.PLUS].
 ...
 * 
 * The default value is [GroupNodeStyleIconType.NONE].
 ...
 * 
 * The default value is [GroupNodeStyleIconBackgroundShape.ROUND_RECTANGLE_SOLID].
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/GroupNodeStyle%23tabInset">Online Documentation</a>
 */
final var tabInset: Double
/**
