 ...
 * @param [renderer] Custom renderer instance for this style. If none is provided a new [ShapeNodeStyleRenderer] instance is used.
 ...
 */
external open class ShapeNodeStyle  (
final override val renderer: ShapeNodeStyleRenderer = definedExternally) : INodeStyle {
 ...
 */
open var keepIntrinsicAspectRatio: Boolean
/**
