 ...
 */
external interface IEdgeStyleRenderer : YObject {
/**
 ...
 * @return An implementation that may be used to subsequently query the edge's painting bounds. Clients should not cache this instance and must always call this method immediately before using the value returned. This enables the use of the flyweight design pattern for implementations
 ...
 */
   fun getMarqueeTestable( edge: IEdge ,
 ...
 */
   fun getPathGeometry( edge: IEdge ,
 ...
 */
   fun getVisibilityTestable( edge: IEdge ,
