 ...
 * @param [renderer] An optional custom renderer instance for this style. The default is [ArrowNodeStyleRenderer].
 ...
 */
external open class ArrowNodeStyle  ( renderer: ArrowNodeStyleRenderer?  = definedExternally) : INodeStyle {
 ...
 * 
 * The default value is [ArrowNodeDirection.RIGHT].
 ...
 */
final override val renderer: ArrowNodeStyleRenderer
/**
 * Gets or sets the thickness of the arrow shaft as ratio of the node size.
