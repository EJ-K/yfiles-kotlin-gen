 ...
 */
external class SvgDefsManager (
final val defs: SVGDefsElement)  {
  /**
   * Gets or sets a soft limit for the runtime of the [defs cleanup][SvgDefsManager] that the method tries to respect.
   * 
  ...
  /**
   * Gets or sets the prefix to use for the [unique IDs][SvgDefsManager].
   * 
   ...
   */
  fun generateUniqueDefsId(): String
