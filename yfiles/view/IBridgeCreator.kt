 ...
 */
external interface IBridgeCreator  {
  /**
   * Called by the [BridgeManager] if the [getCrossingStyle][IBridgeCreator] method yields [CUSTOM][BridgeCrossingStyle] to actually insert a bridge into the given [GeneralPath].
   ...
   * @return The style to use, or [CUSTOM][BridgeCrossingStyle] in order to let [BridgeManager] call [createCustomBridge][IBridgeCreator].
   ...
   * @return The style to use. Any value can be returned and will be ignored if the [crossing style][IBridgeCreator] is set to [CUSTOM][BridgeCrossingStyle].
