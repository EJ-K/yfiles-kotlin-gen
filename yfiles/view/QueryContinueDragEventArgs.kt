...
/**
 * The event argument class that is used by [query-continue-drag][DragSource] during drags.
...
external class QueryContinueDragEventArgs  : EventArgs {
  ...
  /**
   * Gets the current [dropTarget][QueryContinueDragEventArgs] or null of there is no drop target.
