 ...
 */
@JsName("from")
 final  operator fun <TElement : SVGElement, TTag>TElement.invoke( tag: TTag? ):TaggedSvgVisual<TElement, TTag>
/**
 ...
 */
   fun SVGElement.setScale( scaleX: Double ,
 scaleY: Double )
/**
 ...
 */
   fun SVGElement.setTranslate( dx: Double ,
 dy: Double )
}
}
