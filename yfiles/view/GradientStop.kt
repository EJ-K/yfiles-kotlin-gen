 ...
 */
external open class GradientStop  ( color: Color?  = definedExternally,
 offset: Double  = definedExternally) : ICloneable<GradientStop> {
/**
 ...
 */
 final override   fun clone():GradientStop
/**
