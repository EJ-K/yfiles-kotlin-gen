 ...
 * @param [url] The url pointing to the cursor's image.
 * @param [alternative] Cursors can be chained but the last alternative needs to be one of the predefined cursors.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/Cursor%23Cursor-constructor-Cursor(string,Cursor)">Online Documentation</a>
 */
external class Cursor (
   ...
   * @param [url] The url pointing to the cursor's image.
   * @param [x] The x-coordinate of the cursor's hot-spot
   * @param [y] The y-coordinate of the cursor's hot-spot
   * @param [alternative] Cursors can be chained but the last alternative needs to be one of the predefined cursors.
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/Cursor%23Cursor-constructor-Cursor(string,number,number,Cursor)">Online Documentation</a>
   */ constructor(
    url: String,
    x: Double,
    y: Double,
  ...
  companion object : ClassMetadata<Cursor> {
    ...
    /**
     * Gets the cursor indicating that something can be grabbed (usually in conjunction with [GRABBING][Cursor]).
     * @see <a href="https://docs.yworks.com/yfileshtml/#/api/Cursor%23GRAB">Online Documentation</a>
     */
     val GRAB: Cursor
    
    /**
     * Gets the cursor indicating that something is currently being grabbed (usually in conjunction with [GRAB][Cursor] ).
