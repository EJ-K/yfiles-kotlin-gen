...
/**
 * Base class for [Visual]s that use WebGL version 1 for rendering the visualization onto a [WebGLRenderingContext].
 * @see [WebGL2Visual]
 * @see [render]
 ...
 */
abstract external class WebGLVisual () : Visual {
  /**
