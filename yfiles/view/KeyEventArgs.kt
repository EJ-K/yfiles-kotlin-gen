 ...
 * @param [isPrintable] if set to `true` [is printable].
 ...
 */
external open class KeyEventArgs  (
 event: KeyboardEvent ,
 isPrintable: Boolean ,
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/KeyEventArgs%23alt">Online Documentation</a>
 */
final val alt: Boolean
/**
 * Gets the charcode of the original event, if the original event was a key press.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/KeyEventArgs%23charCode">Online Documentation</a>
 */
final val charCode: Int
/**
 * Gets a value indicating whether the control modifier is pressed.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/KeyEventArgs%23control">Online Documentation</a>
 */
final val control: Boolean
/**
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/KeyEventArgs%23meta">Online Documentation</a>
 */
final val meta: Boolean
/**
 * Gets the modifiers.
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/KeyEventArgs%23originalSource">Online Documentation</a>
 */
final val originalSource: Node?
/**
 * Gets a value indicating whether the shift modifier is pressed.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/KeyEventArgs%23shift">Online Documentation</a>
 */
final val shift: Boolean
/**
