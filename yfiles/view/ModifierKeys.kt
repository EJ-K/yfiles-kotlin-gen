...
/**
 * Flag value that indicates which modifier keys were pressed.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ModifierKeys">Online Documentation</a>
 */
external class ModifierKeys 
    private constructor(): YFlags<ModifierKeys> {
    companion object {
    /**
...
/**
 * Indicates that the windows (or meta) key was pressed.
 * 
 * Value - `8`
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ModifierKeys%23WINDOWS">Online Documentation</a>
 */
val WINDOWS: ModifierKeys
