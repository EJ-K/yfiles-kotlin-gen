...
/**
 * An implementation of the [IObstacleProvider] interface that uses the [edges][IGraph.edges] and [nodes][IGraph.nodes] of an [IGraph] as obstacles.
 ...
 */
external open class GraphObstacleProvider  : IObstacleProvider {

/**
 * Gets or sets a value indicating whether to query the [IGraph.edges] for an [IObstacleProvider] implementation.
 * 
 * The default is `true`.
...
/**
 * Gets or sets a value indicating whether to query the [IGraph.nodes] for an [IObstacleProvider] implementation.
 ...
 */
 open protected   fun getGraph( context: IRenderContext ):IGraph?
/**
 * Iterates over all [IGraph.edges] and [IGraph.nodes] to query an [IObstacleProvider] from the [IModelItem][yfiles.graph.IModelItem]'s [ILookup.lookup][yfiles.graph.ILookup.lookup].
