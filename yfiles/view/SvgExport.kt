 ...
 * @param [worldBounds] the bounds of the content to export, see [worldBounds]
 * @param [scale] the scale, see [scale]
 ...
 */
external open class SvgExport  (
open var worldBounds: Rect,
final var scale: Double = definedExternally) : YObject {
...
/**
 * Gets or sets the [CanvasComponent.projection] to apply to the exported image.
...
/**
 * Gets or sets the points in world coordinates which are enclosed in the exported area.
...
/**
 * Gets or sets the [ICanvasContext.zoom] property to use during the creation of the visualization.
 ...
 */
 final   fun calculateScaleForHeight( height: Double ):Double
/**
 ...
 */
 final   fun calculateScaleForWidth( width: Double ):Double
/**
 * Returns a suitable clip to use for the visual for this exporter.
 * @return The clip to set on the visual in order not to paint into the margins.
 ...
 * @param [canvas] The [CanvasComponent] instance to export.
 ...
 */
 open   fun createRenderContext( canvas: CanvasComponent ):IRenderContext
/**
 ...
 */
 final   fun exportSvg( canvas: CanvasComponent ):SVGSVGElement
/**
 * Exports the contents of the [CanvasComponent] to a single, standalone SVG element.
 * @param [canvas] The canvas to be exported.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/SvgExport%23SvgExport-method-exportSvgAsync">Online Documentation</a>
 */
 final   fun exportSvgAsync( canvas: CanvasComponent ):Promise<SVGSVGElement>
/**
 ...
 */
 open protected   fun fixViewBoxAttribute( importedSvg: Element ,
 originalImage: Any /* SVGImageElement | HTMLImageElement */ ):Promise<Void>
/**
 ...
 */
 open protected   fun prepareInlinedImage( importedSvg: Element ,
 originalImage: Any /* SVGImageElement | HTMLImageElement */ ):Element
/**
 ...
 */
 open protected   fun shouldEncodeImageBase64( image: SVGImageElement ):Boolean
/**
 ...
 */
 open protected   fun shouldInlineSvgImage( image: SVGImageElement ):Boolean
 ...
 */
 final   fun encodeSvgDataUrl( svgXml: String ):String
/**
 ...
 */
 final   fun exportSvgString( svg: SVGElement ):String
}
}
