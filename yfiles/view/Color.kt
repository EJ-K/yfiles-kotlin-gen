...
final val a: Int = definedExternally) : YObject {
 ...
 */
@JsName("from")
 final  operator fun invoke( colorLike: String ):Color
/**
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/Color%23Color-method-fromArgb">Online Documentation</a>
 */
 final   fun fromArgb( a: Int ,
 r: Int ,
 g: Int ,
 b: Int ):Color
/**
 ...
 */
 final   fun fromHSLA( h: Double ,
 s: Double ,
 l: Double ,
 a: Double  = definedExternally):Color
/**
