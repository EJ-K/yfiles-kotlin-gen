 ...
 */
external open class BridgeManager  () : YObject {

/**
 * Gets or sets the [BridgeCrossingPolicy] mode that is used by this instance.
 * 
 * By default the [BridgeCrossingPolicy.HORIZONTAL_BRIDGES_VERTICAL] mode is set.
...
/**
 * Gets or sets the margin by which the [IRenderContext.clip] should be enlarged to accommodate for clipped away lines being taken into account for bridge calculation.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/BridgeManager%23clipMargin">Online Documentation</a>
 */
final var clipMargin: Double
/**
 * Gets or sets a value that determines whether curves ([cubic][GeneralPath.cubicTo] and [quadratic][GeneralPath.quadTo]) should be considered as obstacles.
 ...
 * 
 * The default value is `10.0`. Setting this value will adjust the [clipMargin].
 ...
 */
 open   fun addBridges( context: IRenderContext ,
 path: GeneralPath ,
 callback: IBridgeCreator?  = definedExternally):GeneralPath
/**
 ...
 */
 open   fun addObstacleProvider( provider: IObstacleProvider )
/**
 ...
 */
 open   fun getObstacleHash( context: IRenderContext ):Int
/**
 ...
 */
 open   fun insertDefaultCustomBridge( context: IRenderContext ,
 path: GeneralPath ,
 start: Point ,
 end: Point ,
 gapLength: Double )
 ...
 */
 open protected   fun install( canvas: CanvasComponent )
/**
 ...
 */
 open   fun registerObstacle( context: IRenderContext ,
 path: GeneralPath )
/**
 ...
 */
 open   fun registerObstacleCubicCurve( context: IRenderContext ,
 p1: Point ,
 cp1: Point ,
 cp2: Point ,
 p2: Point )
 ...
 */
 open   fun registerObstacleLine( context: IRenderContext ,
 p1: Point ,
 p2: Point )
/**
 ...
 */
 open   fun registerObstacleQuadCurve( context: IRenderContext ,
 p1: Point ,
 cp: Point ,
 p2: Point )
/**
 ...
 */
 open protected   fun registerObstacles( context: IRenderContext )
/**
 * Removes a previously [added][addObstacleProvider] [IObstacleProvider] from the list of registered providers.
 ...
 */
 open   fun removeObstacleProvider( provider: IObstacleProvider )
/**
 ...
 */
 open protected   fun uninstall( canvas: CanvasComponent )
