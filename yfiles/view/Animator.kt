 ...
 */
external open class Animator  (
final val canvasComponent: CanvasComponent) : YObject {
...
/**
 * Gets or sets a value indicating whether to automatically [invalidate the control][invalidateComponent] this instance has been created for.
 * 
 * The default is true.
 ...
 */
 final   fun animate( animation: IAnimation ):Promise<Void>
/**
 ...
 */
 final   fun animate( callback: AnimationCallback ,
 duration: TimeSpan ):Promise<Void>
/**
 ...
 */
 open protected   fun invalidateComponent( canvas: CanvasComponent )
/**
