...
/**
 * This class is used as look-up key for registering [IDataProvider] for [Node]s with a [Graph].
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/NodeDpKey">Online Documentation</a>
 * 
 * @constructor Initializes a new instance of the [NodeDpKey] class.
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/NodeDpKey%23NodeDpKey-constructor-NodeDpKey">Online Documentation</a>
 */
external open class NodeDpKey<TValue : Any>  ( valueType: YClass<TValue> ,
 declaringType: YClass<*> ,
 name: String ) : DpKeyBase<Node, TValue> {

companion object : ClassMetadata<NodeDpKey<*>> {
}
}
