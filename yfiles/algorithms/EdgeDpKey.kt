...
/**
 * This class is used as look-up key for registering [IDataProvider] for [Edge]s with a [Graph].
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/EdgeDpKey">Online Documentation</a>
 * 
 * @constructor Initializes a new instance of the [EdgeDpKey] class.
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/EdgeDpKey%23EdgeDpKey-constructor-EdgeDpKey">Online Documentation</a>
 */
external open class EdgeDpKey<TValue : Any>  ( valueType: YClass<TValue> ,
 declaringType: YClass<*> ,
 name: String ) : DpKeyBase<Edge, TValue> {

companion object : ClassMetadata<EdgeDpKey<*>> {
}
}
