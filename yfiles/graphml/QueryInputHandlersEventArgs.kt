 ...
 * @see [GraphMLIOHandler.query-input-handlers]
 ...
 */
external class QueryInputHandlersEventArgs (
  context: IParseContext,
  keyDefinition: Element,
  handlers: IList<out IInputHandler>,
) : EventArgs {
  /**
  ...
  /**
   * Register an [IInputHandler] instance for the current [keyDefinition][QueryInputHandlersEventArgs].
