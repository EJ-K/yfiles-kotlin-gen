...
external interface IXmlWriter  {
   ...
   * @return The text representation of all content that has been written so far.
   ...
   */
  final fun writeAttribute(
    localName: String,
    value: String,
  ): IXmlWriter = definedExternally
  ...
  /**
   * Closes an XML element previously opened with [writeStartElement][IXmlWriter] or [writeStartElement][IXmlWriter].
   * @return The writer instance for further chaining
   ...
   */
  final fun writeGraphMLXmlAttribute(
   ...
   */
  fun writeProcessingInstruction(
    target: String,
    data: String,
  ): IXmlWriter
