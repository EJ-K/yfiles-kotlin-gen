...
/**
 * This is the event argument that is used by the [IWriteEvents] interface that can be queried from the [IWriteContext.writeEvents] property.
 ...
 * @param [item] The item to assign to [item].
 ...
 */
external open class WriteEventArgs  (
