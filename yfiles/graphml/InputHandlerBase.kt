 ...
 * @param [precedence] The precedence to assign to the [precedence][InputHandlerBase] property.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/InputHandlerBase%23InputHandlerBase-constructor-InputHandlerBase(Constructor,Constructor,ParsePrecedence)">Online Documentation</a>
 * 
 * @property precedence
 ...
 */
abstract external class InputHandlerBase<TKey, TData> protected constructor(
...
final override var precedence: ParsePrecedence = definedExternally) : IInputHandler {
  /**
   * Gets a value indicating whether a default value has been set, either through a key definition element or explicitly by assigning a value to the [defaultValue][InputHandlerBase] property.
   ...
   */
  open fun initializeFromKeyDefinition(
    context: IParseContext,
    definition: Element,
  )
   ...
   */
  protected abstract fun parseDataCore(
    context: IParseContext,
    node: Node,
  ): TData?
