...
/**
 * This is the interface for a factory that is used for creating the constituents of an [IGraph][yfiles.graph.IGraph] that are encountered during the parsing of [GraphML][GraphMLIOHandler]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IGraphElementFactory">Online Documentation</a>
 */
external interface IGraphElementFactory  {
  /**
   * Adds a new port to the given [IPortOwner].
   * @param [context] The context from which the graph, the [CreationProperties], and the [objectStack][IParseContext] can be queried.
