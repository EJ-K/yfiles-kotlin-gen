 ...
 */
external open class ValueSerializer  : YObject {
 ...
 */
 open   fun canConvertFromString( value: String ,
 context: IValueSerializerContext? ):Boolean
/**
 ...
 */
 open   fun canConvertToString( value: Any? ,
 context: IValueSerializerContext? ):Boolean
/**
 ...
 */
 open   fun convertFromString( value: String ,
 context: IValueSerializerContext? ):Any?
/**
 ...
 */
 open   fun convertToString( o: Any? ,
 context: IValueSerializerContext? ):String
 ...
 */
 final   fun getSerializerFor( property: Property ,
 context: IValueSerializerContext ):ValueSerializer?
/**
 * Gets the [ValueSerializer] implementation for the given type.
 * @param [type] The type.
 * @param [context] The context.
 * @return The serializer to use for the type.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ValueSerializer%23ValueSerializer-method-getSerializerFor(yfiles.lang.Class,IValueSerializerContext)">Online Documentation</a>
 */
 final   fun getSerializerFor( type: YClass<*> ,
 context: IValueSerializerContext ):ValueSerializer?
}
}
