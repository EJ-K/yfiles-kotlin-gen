...
/**
 * The event arguments used by [GraphMLIOHandler.QueryType] to override automatic type resolution in GraphML.
 ...
 * @param [context] The context in the lookup should take place.
 ...
 * 
 * @property context
 * Gets the context in which the [Class][yfiles.lang.Class] shall mapped.
 ...
 */
external open class QueryTypeEventArgs  (
