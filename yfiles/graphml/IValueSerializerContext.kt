...
external interface IValueSerializerContext : ILookup {
   ...
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IValueSerializerContext%23IValueSerializerContext-method-getValueSerializerFor(Constructor)">Online Documentation</a>
   */
  fun getValueSerializerFor(
    type: IClassMetadata<*>,
  ): ValueSerializer?
