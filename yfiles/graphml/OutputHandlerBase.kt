 ...
 */
external abstract class OutputHandlerBase<TKey : Any, TData : Any> 
protected constructor ( keyType: YClass<TKey> ,
 dataType: YClass<TData> ,
 scope: KeyScope ,
 name: String? ,
 type: KeyType ) : IOutputHandler {

/**
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/OutputHandlerBase%23dataTagAttributes">Online Documentation</a>
 */
override val dataTagAttributes: IEnumerable<GraphMLXmlAttribute>
/**
 ...
 */
override val keyDefinitionAttributes: IEnumerable<GraphMLXmlAttribute>
/**
 ...
 */
 abstract protected   fun getValue( context: IWriteContext ,
 key: TKey ):TData?
/**
 ...
 */
 override   fun isDefaultValue( context: IWriteContext ):Boolean
/**
 ...
 */
 final   fun setKeyDefinitionName( name: String? )
/**
 ...
 */
 final   fun setKeyDefinitionScope( scope: KeyScope )
/**
 ...
 */
 final   fun setKeyDefinitionType( type: KeyType )
/**
 ...
 */
 final   fun setKeyDefinitionUri( uri: String? )
/**
 ...
 */
 final override   fun writeValue( context: IWriteContext )
/**
 ...
 */
 abstract protected   fun writeValueCore( context: IWriteContext ,
 data: TData? )
