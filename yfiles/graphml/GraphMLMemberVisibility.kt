 ...
 * @see [GraphMLAttribute.visibility]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/GraphMLMemberVisibility">Online Documentation</a>
 */
external sealed class GraphMLMemberVisibility: YEnum<GraphMLMemberVisibility> {
   companion object: EnumMetadata<GraphMLMemberVisibility> {
       /**
 ...
 */
val VISIBLE: GraphMLMemberVisibility
 ...
 */
val CONTENT: GraphMLMemberVisibility
 ...
 */
val HIDDEN: GraphMLMemberVisibility
   }
}
