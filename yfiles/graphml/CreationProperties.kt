 ...
 */
external open class CreationProperties  () : YObject {
 ...
 */
 open  operator fun <T : Any>get( key: CreationPropertyKey<T> ):T?
/**
 ...
 */
 final   fun removeValue( key: CreationPropertyKey<*> )
/**
 ...
 */
 open  operator fun <T : Any>set( key: CreationPropertyKey<T> ,
 value: T )
...
/**
 * Creation property key that tags [tag][yfiles.graph.ITagOwner.tag] object information.
 * @see [IGraphElementFactory]
