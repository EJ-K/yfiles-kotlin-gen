...
external class TimeSpan (
  ...
  companion object : ClassMetadata<TimeSpan> {
    /**
     * A timespan with duration [MAX_SAFE_INTEGER][Number].
     * @see <a href="https://docs.yworks.com/yfileshtml/#/api/TimeSpan%23MAX_VALUE">Online Documentation</a>
     */
     val MAX_VALUE: TimeSpan
