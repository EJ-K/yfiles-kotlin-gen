 ...
 */
external interface INodeDefaults  {
  /**
  ...
  /**
   * Gets or sets a value indicating whether the [style][INodeDefaults] instance should be shared referentially or [cloned][yfiles.lang.ICloneable] upon a call to [getStyleInstance][INodeDefaults].
   ...
   * @return The style to use, which for most implementations is either a [clone][yfiles.lang.ICloneable] of or the [style][INodeDefaults] property, if [shareStyleInstance][INodeDefaults] is enabled.
