 ...
 * @param [index] The index the bend state shall be inserted in the [bends]; a negative value (which is the default) indicates that the bend should be appended to the end of the list of bends.
 ...
 */
 final   fun addBend( location: Point ,
 index: Int  = definedExternally):FoldingBendState
/**
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/FoldingEdgeState%23FoldingEdgeState-method-remove(FoldingBendState)">Online Documentation</a>
 */
 final   fun remove( bend: FoldingBendState )
 ...
 */
@JsName("remove")
  final operator fun minusAssign( bend: FoldingBendState )
/**
 * Removes the `label` from its owning [FoldingLabelOwnerState].
 * @param [label] The label to remove.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/FoldingEdgeState%23FoldingEdgeState-method-remove(FoldingLabelState)">Online Documentation</a>
 */
