 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23accumulatedInsets">Online Documentation</a>
 */
final val accumulatedInsets: Insets
/**
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23insets">Online Documentation</a>
 */
var insets: Insets
/**
 ...
 * @param [preferredSize] The initial values to use for the [ILabel.preferredSize].
 ...
 */
  final  fun calculateLabelPreferredSize( stripe: IStripe ,
 style: ILabelStyle ,
 layoutParameter: ILabelModelParameter ,
 text: String ,
 tag: Tag? ):Size = definedExternally
/**
...
/**
 * Create a new column as the `index`th child of `owner` with the given parameters.
 * @param [owner] The owner of the new column.
 * @param [width] The actual width of the column.
 * @param [minWidth] The minimal width of the column.
 * @param [insets] The insets of the column.
 ...
 */
   fun createChildColumn( owner: IColumn? ,
 width: Double?  = definedExternally,
 minWidth: Double?  = definedExternally,
 insets: Insets?  = definedExternally,
 style: IStripeStyle?  = definedExternally,
 tag: Tag?  = definedExternally,
 index: Int?  = definedExternally):IColumn
/**
 * Create a new row as the `index`th child of `owner` with the given parameters.
 * @param [owner] The owner of the new row.
 * @param [height] The actual height of the row.
 * @param [minHeight] The minimal height of the row.
 * @param [insets] The insets of the row.
 ...
 * @see [addStripeCreatedListener]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23ITable-defaultmethod-createColumn">Online Documentation</a>
 */
  final  fun createColumn( width: Double?  = definedExternally,
 minWidth: Double?  = definedExternally,
 insets: Insets?  = definedExternally,
 style: IStripeStyle?  = definedExternally,
 tag: Tag?  = definedExternally,
 index: Int?  = definedExternally):IColumn = definedExternally
/**
 ...
 */
  final  fun createGrid( columns: Int ,
 rows: Int ):Unit = definedExternally
/**
 * Creates the label model parameter for a given [ILabelOwner].
 * @param [stripe] The item that is the [ILabel.owner] of the label in question.
 ...
 */
  final  fun createLabelLayoutParameter( stripe: IStripe ):ILabelModelParameter = definedExternally
/**
 * Creates an instance of the [default label style][ILabelDefaults.style] for the given `stripe`.
 ...
 */
  final  fun createLabelStyle( stripe: IStripe ):ILabelStyle = definedExternally
/**
 ...
 */
  final  fun createRow( height: Double?  = definedExternally,
 minHeight: Double?  = definedExternally,
 insets: Insets?  = definedExternally,
 style: IStripeStyle?  = definedExternally,
 tag: Tag?  = definedExternally,
 index: Int?  = definedExternally):IRow = definedExternally
/**
 ...
 */
  final  fun findColumn( node: INode ,
 location: Point ,
 filter: Predicate<IStripe>?  = definedExternally):IColumn? = definedExternally
/**
 ...
 */
  final  fun findRow( node: INode ,
 location: Point ,
 filter: Predicate<IStripe>?  = definedExternally):IRow? = definedExternally
/**
 ...
 */
  final  fun findStripes( node: INode ,
 location: Point ,
 stripeTypes: StripeTypes ,
 filter: Predicate<IStripe>?  = definedExternally):IEnumerable<IStripe> = definedExternally
/**
 ...
 * @return The relative bounds of a the cell determined by `column` and `row`
 ...
 */
  final  fun getCellBounds( column: IColumn ,
 row: IRow ):Rect = definedExternally
/**
 ...
 */
@JsName("remove")
  final operator fun minusAssign( label: ILabel ):Unit = definedExternally
/**
 ...
 */
@JsName("remove")
  final operator fun minusAssign( stripe: IStripe ):Unit = definedExternally
/**
 * [Removes][remove] `stripe` and all of its descendants from `table`.
 * @param [stripe] The stripe to remove
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23ITable-defaultmethod-removeRecursively">Online Documentation</a>
 */
  final  fun removeRecursively( stripe: IStripe ):Unit = definedExternally
/**
 * [Removes][removeWithResize] the given `stripe` and all of its descendants from `table` and resizes all affected stripes so that the table size does not change if possible.
 * @param [stripe] The stripe to remove
 ...
 */
  final  fun removeRecursivelyWithResize( stripe: IStripe ):Unit = definedExternally
/**
 * [Removes][remove] `stripe` from `table` and resizes all affected stripes so that the table size does not change if possible.
 * @param [stripe] The stripe to remove
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23ITable-defaultmethod-removeWithResize">Online Documentation</a>
 */
  final  fun removeWithResize( stripe: IStripe ):Unit = definedExternally
/**
 ...
 */
   fun setMinimumSize( stripe: IStripe ,
 minimumSize: Double )
/**
 ...
 */
   fun setSize( stripe: IStripe ,
 size: Double )
/**
 * Sets the insets of `stripe`.
 * @param [stripe] The stripe to change
 * @param [insets] The new insets of the stripe
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23ITable-method-setStripeInsets">Online Documentation</a>
 */
   fun setStripeInsets( stripe: IStripe ,
 insets: Insets )
/**
 ...
 */
   fun setStyle( stripe: IStripe ,
 style: IStripeStyle )
/**
 * Occurs when a label has been added to this graph instance.
 * @see [addLabel]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23LabelAdded">Online Documentation</a>
 */
 ...
 * @see [remove]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23LabelRemoved">Online Documentation</a>
 */
 ...
 * @see [setStyle]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23LabelChanged">Online Documentation</a>
 */
fun addLabelChangedListener(listener: EventHandler1<ItemEventArgs<ILabel>>)
fun removeLabelChangedListener(listener: EventHandler1<ItemEventArgs<ILabel>>)

/**
 * Occurs when a stripe has been added.
 * @see [createChildRow]
 * @see [createChildColumn]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23StripeCreated">Online Documentation</a>
 */
 ...
 * @see [remove]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23StripeRemoved">Online Documentation</a>
 */
fun addStripeRemovedListener(listener: EventHandler1<StripeEventArgs>)
fun removeStripeRemovedListener(listener: EventHandler1<StripeEventArgs>)
 ...
 * @see [setSize]
 * @see [setMinimumSize]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23StripeChanged">Online Documentation</a>
 */
 ...
 * @param [canvas] The canvas that provides necessary context for hit determination, such as [ICanvasContext.hitTestRadius][yfiles.view.ICanvasContext.hitTestRadius].
 * @param [filter] Additional predicate to further restrict the hit test results.
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23ITable-defaultmethod-findStripes">Online Documentation</a>
 */
   fun findStripes( location: Point ,
 stripeTypes: StripeTypes ,
 subregionTypes: StripeSubregionTypes ,
 canvas: CanvasComponent ,
 ...
 * @param [column] The column that determines the cell
 * @param [row] The row that determines the cell
 * @return The absolute bounds of a the cell determined by `column` and `row`
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ITable%23ITable-defaultmethod-getCellBounds">Online Documentation</a>
 */
   fun INode.getCellBounds( column: IColumn ,
 row: IRow ):Rect
/**
 ...
 */
   fun IGraph.placeNodeInCell( node: INode ,
 tableNode: INode ,
 column: IColumn ,
 row: IRow ,
...
inline fun  ITable.addLabelChangedHandler(
    ...
    val listener: EventHandler1<ItemEventArgs<ILabel>> = { _, event -> handler(event.item) }
    addLabelChangedListener(listener)
    return { removeLabelChangedListener(listener) }
}
/**
 * Occurs when a stripe has been added.
 * @see [createChildRow]
...
inline fun  ITable.addStripeRemovedHandler(
    ...
    addStripeRemovedListener(listener)
    return { removeStripeRemovedListener(listener) }
}
/**
 * Occurs when a stripe has been changed, for instance, if its style has been replaced.
 * @see [setStyle]
