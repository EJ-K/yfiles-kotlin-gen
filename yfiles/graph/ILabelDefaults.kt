 ...
 */
external interface ILabelDefaults : YObject {
/**
...
/**
 * Gets or sets a value indicating whether the [layoutParameter] instance should be shared referentially or [cloned][yfiles.lang.ICloneable.clone] upon a call to [getLayoutParameterInstance].
 * @see [getLayoutParameterInstance]
 * @see [layoutParameter]
 ...
 * @return The parameter to use, which for most implementations is either a [clone][yfiles.lang.ICloneable.clone] of or the [layoutParameter] property, if [shareLayoutParameterInstance] is enabled.
 ...
 */
   fun getLayoutParameterInstance( owner: ILabelOwner ):ILabelModelParameter
/**
 ...
 */
   fun getStyleInstance( owner: ILabelOwner ):ILabelStyle
