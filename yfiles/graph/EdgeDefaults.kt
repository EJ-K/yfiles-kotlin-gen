 ...
 * 
 * @constructor Initializes a new instance of the [EdgeDefaults] class with default edge style and label and port defaults.
 ...
 */
external open class EdgeDefaults  () : IEdgeDefaults {
