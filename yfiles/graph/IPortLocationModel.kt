 ...
 */
external interface IPortLocationModel : ILookup {
/**
 ...
 */
   fun createParameter( owner: IPortOwner ,
 location: Point ):IPortLocationModelParameter
/**
 * Provides a [lookup context][ILookup] for the given combination of port and parameter.
 * @param [port] The port to use in the context.
 * @param [locationParameter] The parameter to use for the port in the context.
 * @return An implementation of the [ILookup] interface that can be used to query additional aspects of the port/parameter combination.
 ...
 * @param [locationParameter] The parameter to use. The parameter can be expected to be created by this instance having the [IPortLocationModelParameter.model] property set to this instance..
