...
external interface IStripe : ILabelOwner {
  ...
  /**
   * Gets the index of `stripe` in its [parentStripe][IStripe] collection of [childStripes][IStripe].
  ...
  /**
   * Gets the minimal permissible value for [size][IStripe].
   ...
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IStripe%23padding">Online Documentation</a>
   */
  val padding: Insets
   ...
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IStripe%23totalPadding">Online Documentation</a>
   */
  final val totalPadding: Insets
  
  /**
   * Returns the layout of `stripe` in absolute coordinates.
   * @param [node] The node relative to which the stripe layout is calculated. This should be the same node where [table][IStripe] for `stripe` is associated to.
   * @return The layout of the supplied stripe in absolute coordinates.
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IStripe%23IStripe-defaultmethod-getAbsoluteBounds">Online Documentation</a>
   */
  final fun getAbsoluteBounds(
    node: INode,
