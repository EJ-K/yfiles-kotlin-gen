 ...
 */
external interface IMementoSupport<in T, S>  {
  /**
   * Reapplies a previously queried state object to a given subject.
   * @param [subject] The subject to modify the state.
   * @param [state] The state object as returned by [getState][IMementoSupport]
   ...
   * @param [state1] The first state as obtained from [getState][IMementoSupport]
   * @param [state2] The second state as obtained from [getState][IMementoSupport]
