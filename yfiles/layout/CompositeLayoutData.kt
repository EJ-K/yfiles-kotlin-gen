 ...
 * 
 * @constructor Creates a new instance which combines the given `items`.
 ...
 */
external open class CompositeLayoutData  (vararg  items: LayoutData ) : LayoutData {
 ...
 */
final var items: ICollection<out LayoutData>
