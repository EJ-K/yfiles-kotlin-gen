 ...
 * 
 * @constructor Creates a new [Neighborhood] instance.
 ...
 */
external open class Neighborhood  () : YObject {
 ...
 * @return A [NeighborhoodResult] containing neighbors of the [startNodes] in the given [direction][traversalDirection].
 ...
 */
 final   fun run( graph: IGraph ):NeighborhoodResult
