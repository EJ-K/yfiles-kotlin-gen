 ...
 * 
 * @constructor Creates a new [Reachability] instance.
 ...
 */
external open class Reachability  () : YObject {
 ...
 * @return A [ReachabilityResult] containing the nodes reachable from [startNodes].
 ...
 */
 final   fun run( graph: IGraph ):ReachabilityResult
