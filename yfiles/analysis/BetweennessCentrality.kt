 ...
 * @see [LayoutGraphAlgorithms.nodeEdgeBetweenness]
 * @see [LayoutGraphAlgorithms.nodeBetweenness]
 * @see [LayoutGraphAlgorithms.edgeBetweenness]
 ...
 */
external class BetweennessCentrality ()  {
  /**
