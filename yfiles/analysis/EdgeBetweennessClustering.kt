 ...
 * 
 * @constructor Creates a new [EdgeBetweennessClustering] instance.
 ...
 */
external open class EdgeBetweennessClustering  () : YObject {
 ...
 */
 final   fun run( graph: IGraph ):EdgeBetweennessClusteringResult
