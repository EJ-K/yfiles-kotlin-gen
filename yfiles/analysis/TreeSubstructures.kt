...
/**
 * Detects [SubstructureItems]s that represent isolated trees in the specified graph.
 ...
 */
external open class TreeSubstructures  () : YObject {
...
/**
 * Returns a list of [SubstructureItems]s that represent isolated trees in the specified graph.
 * @param [graph] The graph to find the substructures in.
 * @return A list of [SubstructureItems]s that represent the trees.
 ...
 */
 final   fun run( graph: IGraph ):TreeSubstructuresResult
