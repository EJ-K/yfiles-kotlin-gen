 ...
 */
external  class TreeAnalysisResult 
 ...
 * @throws ArgumentError If the given node was not part of the graph at the time the analysis was invoked via [TreeAnalysis.run]
 ...
 */
 final   fun getChildren( node: INode ):ResultItemCollection<INode>
/**
 ...
 */
 final   fun getDescendants( root: INode ):Subtree
/**
 ...
 * @throws ArgumentError If `nodes` contain `null` or if one of the nodes was not part of the graph at the time the analysis was invoked via [TreeAnalysis.run].
...
/**
 * Gets all nodes and edges of the sub-tree that has `subtreeRoot` as root.
 * @param [subtreeRoot] The sub-tree root node.
 * @return A [Subtree] holding the nodes and edges of the sub-tree rooted at the given `subtreeRoot`.
 * @throws ArgumentError If the given node was not part of the graph at the time the analysis was invoked via [TreeAnalysis.run]
 ...
 */
 final   fun getSubtree( subtreeRoot: INode ):Subtree
