 ...
 * @see [SpanningTrees.uniform][yfiles.algorithms.SpanningTrees.uniform]
 * @see [SpanningTrees.minimum][yfiles.algorithms.SpanningTrees.minimum]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/SpanningTree">Online Documentation</a>
 * 
 * @constructor Creates a new [SpanningTree] instance.
 ...
 */
external open class SpanningTree  () : YObject {
 ...
 */
 final   fun run( graph: IGraph ):SpanningTreeResult
