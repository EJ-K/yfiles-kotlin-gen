...
/**
 * Finds shortest paths between pairs of multiple [sources][AllPairsShortestPaths] and [sinks][AllPairsShortestPaths].
 ...
 */
external class AllPairsShortestPaths ()  {
  /**
  ...
  /**
   * Finds all shortest paths between pairs of nodes from [sources][AllPairsShortestPaths] and [sinks][AllPairsShortestPaths].
   * @param [graph] The graph on which the shortest paths are computed.
   * @return A [AllPairsShortestPathsResult] containing all shortest paths between nodes from [sources][AllPairsShortestPaths] and [sinks][AllPairsShortestPaths].
