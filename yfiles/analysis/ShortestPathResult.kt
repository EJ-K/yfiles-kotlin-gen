 ...
 */
external  class ShortestPathResult 
...
/**
 * Gets a collection of nodes along the path, starting with the [ShortestPath.source] node and ending with the [ShortestPath.sink] node.
...
/**
 * Gets the shortest path found between [ShortestPath.source] and [ShortestPath.sink] if one exists.
