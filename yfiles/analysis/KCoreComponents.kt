 ...
 * @see [GraphConnectivity.kCore][yfiles.algorithms.GraphConnectivity.kCore]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/KCoreComponents">Online Documentation</a>
 * 
 * @constructor Creates a new [KCoreComponents] instance.
 ...
 */
external  class KCoreComponents  () : YObject {
 ...
 */
 final   fun run( graph: IGraph ):KCoreComponentsResult
