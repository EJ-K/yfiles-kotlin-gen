 ...
 * @see [Centrality.degreeCentrality][yfiles.algorithms.Centrality.degreeCentrality]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/DegreeCentrality">Online Documentation</a>
 * 
 * @constructor Creates a new [DegreeCentrality] instance.
 ...
 */
external open class DegreeCentrality  () : YObject {
 ...
 * Computes the degree centrality for the nodes of a given graph.
 * ### Preconditions
 * - At least one of the flags [considerIncomingEdges] and [considerOutgoingEdges] must be `true`.
 ...
 */
 final   fun run( graph: IGraph ):DegreeCentralityResult
