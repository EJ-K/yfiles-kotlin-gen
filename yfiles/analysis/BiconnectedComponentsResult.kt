 ...
 */
external class BiconnectedComponentsResult   {
  /**
   ...
   * @param [node] The node for which the biconnected components are retrieved.
   * @return A collection of all biconnected components that contain the given `node`.
