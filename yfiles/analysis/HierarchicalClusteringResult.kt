 ...
 */
external class HierarchicalClusteringResult private constructor()  {
  /**
  ...
  /**
   * Gets the root of the dendrogram which is used internally to generate the [clusters][HierarchicalClusteringResult].
   ...
   * @return A new [HierarchicalClusteringResult] with the same [dendrogramRoot][HierarchicalClusteringResult] and [clusters][HierarchicalClusteringResult] calculated based on that dendrogram and the `clusterCount`.
   ...
   * @return A new [HierarchicalClusteringResult] with the same [dendrogramRoot][HierarchicalClusteringResult] and [clusters][HierarchicalClusteringResult] calculated based on that dendrogram and `cutoff`.
   ...
   * @param [node] The node for which to retrieve the representative in the dendrogram.
   * @return The representative of `node` in the dendrogram.
   * @see [dendrogramRoot]
