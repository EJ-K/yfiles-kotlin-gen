 ...
 */
external  class BipartitionResult 
 ...
 * @return `true` if both nodes are in the same partition, `false` if they are in different partitions. If the graph is [not bipartite][isBipartite], `true` is returned.
 ...
 */
 final   fun inSamePartition( node1: INode ,
 node2: INode ):Boolean
