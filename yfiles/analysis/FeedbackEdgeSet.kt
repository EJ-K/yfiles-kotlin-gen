 ...
 * @see [Cycles.findCycleEdges][yfiles.algorithms.Cycles.findCycleEdges]
 * @see [Cycles.findCycleEdgesDFS][yfiles.algorithms.Cycles.findCycleEdgesDFS]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/FeedbackEdgeSet">Online Documentation</a>
 * 
 * @constructor Creates a new [FeedbackEdgeSet] instance.
 ...
 */
external  class FeedbackEdgeSet  () : YObject {
 ...
 */
 final   fun run( graph: IGraph ):FeedbackEdgeSetResult
