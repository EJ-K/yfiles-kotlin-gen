 ...
 * @see [Groups.getClusteringCoefficient][yfiles.algorithms.Groups.getClusteringCoefficient]
 ...
 */
external open class ClusteringCoefficient  () : YObject {
 ...
 */
 final   fun run( graph: IGraph ):ClusteringCoefficientResult
