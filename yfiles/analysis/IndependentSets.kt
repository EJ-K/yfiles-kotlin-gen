 ...
 * @see [IndependentSets.getIndependentSets][yfiles.algorithms.IndependentSets.getIndependentSets]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IndependentSets">Online Documentation</a>
 * 
 * @constructor Creates a new [IndependentSets] instance.
 ...
 */
external open class IndependentSets  () : YObject {
 ...
 * Partitions the set of nodes of the given graph into independent sets.
 * ### Preconditions
 * - The input graph is [simple][GraphStructureAnalyzer.isSimple] i.e., it contains neither parallel edges nor self-loops.
 ...
 */
 final   fun run( graph: IGraph ):IndependentSetsResult
