 ...
 */
external class ResultItemMapping<TKey : Any, TValue : Any> private constructor() : IEnumerable<MapEntry<TKey, TValue>>, IMapper<TKey, TValue> {
  /**
   ...
   */
  override fun getEnumerator(): IEnumerator<MapEntry<TKey, TValue>>
