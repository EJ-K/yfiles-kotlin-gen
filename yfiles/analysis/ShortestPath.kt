 ...
 * @see [ShortestPaths.singleSourceSingleSink][yfiles.algorithms.ShortestPaths.singleSourceSingleSink]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ShortestPath">Online Documentation</a>
 * 
 * @constructor Creates a new [ShortestPath] instance.
 ...
 */
external  class ShortestPath  () : YObject {
...
/**
 * Finds the shortest path between [source] and [sink].
 * @param [graph] The input graph to run the algorithm on.
 * @return A [ShortestPathResult] containing the shortest path between [source] and [sink] if one exists.
 ...
 */
 final   fun run( graph: IGraph ):ShortestPathResult
