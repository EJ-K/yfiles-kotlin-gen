 ...
 * @see [GraphConnectivity.biconnectedComponents][yfiles.algorithms.GraphConnectivity.biconnectedComponents]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/BiconnectedComponents">Online Documentation</a>
 * 
 * @constructor Creates a new [BiconnectedComponents] instance.
 ...
 */
external open class BiconnectedComponents  () : YObject {
 ...
 */
 final   fun run( graph: IGraph ):BiconnectedComponentsResult
