 ...
 */
external class EdgeBetweennessClusteringResult private constructor()  {
  /**
  ...
  /**
   * Gets a value that estimates the quality of the partition of the nodes into the [clusters][EdgeBetweennessClusteringResult].
