 ...
 */
external  class MaximumFlowResult 
...
/**
 * Gets a collection of the nodes which are at the sink side of the [minimum cut][minimumCut].
...
/**
 * Gets a collection of the nodes which are at the source side of the [minimum cut][minimumCut].
