...
/**
 * Calculates the transitive edges that connect the [visibleNodes][TransitiveEdges] in the specified graph.
 * @see [LayoutGraphAlgorithms.addTransitiveEdges]
 ...
 */
external class TransitiveEdges ()  {
  /**
