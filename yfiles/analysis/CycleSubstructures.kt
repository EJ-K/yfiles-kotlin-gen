...
/**
 * Detects [SubstructureItems]s that represent the isolated cycles in the specified graph.
 ...
 */
external open class CycleSubstructures  () : YObject {
...
/**
 * Returns a list of [SubstructureItems]s that represent isolated cycles in the specified graph.
 * @param [graph] The graph to find the substructures in.
 * @return A list of [SubstructureItems]s that represent the cycles.
 ...
 */
 final   fun run( graph: IGraph ):CycleSubstructuresResult
