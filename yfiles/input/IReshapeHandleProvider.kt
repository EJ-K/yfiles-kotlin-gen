 ...
 */
external interface IReshapeHandleProvider  {
  /**
   ...
   * @return A bitwise combination of all positions the [getHandle][IReshapeHandleProvider] method can be queried for.
