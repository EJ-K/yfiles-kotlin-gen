 ...
 */
external interface IDragHandler  {
  /**
   ...
   * @param [originalLocation] The value of the coordinate of the [location][IDragHandler] property at the time of [initializeDrag][IDragHandler].
   ...
   * @param [context] The context to retrieve information about the drag from.
   * @param [originalLocation] The value of the [location][IDragHandler] property at the time of [initializeDrag][IDragHandler].
   * @param [newLocation] The coordinates in the world coordinate system that the client wants the handle to be at. Depending on the implementation the [location][IDragHandler] may or may not be modified to reflect the new value. This is the same value as delivered in the last invocation of [handleMove][IDragHandler].
   ...
   * @param [context] The context to retrieve information about the drag from.
   * @param [originalLocation] The value of the [location][IDragHandler] property at the time of [initializeDrag][IDragHandler].
   * @param [newLocation] The coordinates in the world coordinate system that the client wants the handle to be at. Depending on the implementation, the [location][IDragHandler] may or may not be modified to reflect the new value.
