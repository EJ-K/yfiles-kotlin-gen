 ...
 */
external interface IClickListener : YObject {
/**
 * Gets an [IHitTestable] that can be used to check if [onClicked] should be invoked.
 * @return A hit testable that can determine whether [onClicked] should be invoked by a given click.
 ...
 */
   fun onClicked( context: IInputModeContext ,
 location: Point )
