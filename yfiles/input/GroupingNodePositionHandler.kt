...
/**
 * The [IPositionHandler] implementation used in the context of [IGraph][yfiles.graph.IGraph]s where there is a [active hierarchy][yfiles.graph.IGraph.getChildren].
 ...
 */
external open class GroupingNodePositionHandler  ( node: INode ,
 wrappedHandler: IPositionHandler?  = definedExternally) : IPositionHandler {

/**
 * Gets or sets a value determining whether the layout of the parent group node are adjusted to always keep the moved node inside.
...
/**
 * Gets or sets a value determining whether [children][yfiles.graph.IGraph.getChildren] of the moved node are implicitly moved with it.
...
/**
 * Gets or sets a value determining whether [reparenting][IReparentNodeHandler.reparent] the moved node is enabled.
 ...
 */
 open protected   fun setCurrentParent( context: IInputModeContext ,
 node: INode ,
 parent: INode? )
