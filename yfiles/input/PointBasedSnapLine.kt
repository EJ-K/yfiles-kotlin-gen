 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/PointBasedSnapLine">Online Documentation</a>
 * 
 * @constructor Initializes a new instance of the [PointBasedSnapLine] class.
 * @param [point] The point to assign to [point].
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/PointBasedSnapLine%23PointBasedSnapLine-constructor-PointBasedSnapLine(IPoint,SnapLineOrientation,SnapLineSnapTypes,SnapLineVisualizationType,Point,Object,number)">Online Documentation</a>
 */
external open class PointBasedSnapLine  ( point: IPoint ,
 ...
 * @param [tag] A tag that is associated with this snap line - see [SnapLine.tag] for a typical use of this value.
 * @param [weight] The weight (importance) of this snap line. If more than one snap line is snapped to, the one with the greater weight will be used.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/PointBasedSnapLine%23PointBasedSnapLine-constructor-PointBasedSnapLine(IPoint,SnapLineOrientation,SnapLineSnapTypes,SnapLineVisualizationType,Point,number,number,Object,number)">Online Documentation</a>
 */
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/PointBasedSnapLine%23point">Online Documentation</a>
 */
final val point: IPoint

companion object : ClassMetadata<PointBasedSnapLine> {
}
}
