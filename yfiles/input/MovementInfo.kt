 ...
 */
abstract external class MovementInfo protected constructor(
final val originalLocation: Point,
final var moveType: MoveTypes,
final val movedItem: IModelItem)  {
  /**
   ...
   */
  open fun movesHorizontallySynchronizedWith(
    info: MovementInfo,
  ): Boolean
   ...
   */
  open fun movesVerticallySynchronizedWith(
    info: MovementInfo,
  ): Boolean
