 ...
 * 
 * @constructor Creates a default instance that provide handles for each of the positions given for the rectangle.
 ...
 */
external open class RectangleReshapeHandleProvider  (
