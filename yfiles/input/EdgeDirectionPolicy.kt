 ...
 */
external sealed class EdgeDirectionPolicy: YEnum<EdgeDirectionPolicy> {
   companion object: EnumMetadata<EdgeDirectionPolicy> {
       /**
 ...
 */
val START_AT_SOURCE: EdgeDirectionPolicy

/**
 * A policy where edges can only be created from target to source port in [reverse][CreateEdgeInputMode.reversedEdgeCreation] direction.
 * 
 * Value - `1`
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/EdgeDirectionPolicy%23START_AT_TARGET">Online Documentation</a>
 */
val START_AT_TARGET: EdgeDirectionPolicy
 ...
 */
val KEEP_DIRECTION: EdgeDirectionPolicy

/**
 * A policy where edges will be created in the direction depending on whether the creation started at a [source][IPortCandidateProvider.getAllSourcePortCandidates] or [target][IPortCandidateProvider.getAllTargetPortCandidates] [IPortCandidate].
 * 
 * Value - `3`
 ...
 */
val DETERMINE_FROM_PORT_CANDIDATES: EdgeDirectionPolicy
   }
}
