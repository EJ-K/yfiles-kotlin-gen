 ...
 */
external interface IPortSelectionTester : YObject {
/**
 ...
 */
   fun getHitPort( context: IInputModeContext ,
 location: Point ):IPort?
/**
 ...
 */
   fun getPortsInBox( context: IInputModeContext ,
 rectangle: Rect ):IEnumerable<IPort>
