...
/**
 * Defines whether to show the visualization of source and target port candidates during edge creation.
 ...
 */
external class ShowPortCandidates 
    private constructor(): YFlags<ShowPortCandidates> {
    companion object {
    /**
 ...
 * 
 * Value - `1`
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ShowPortCandidates%23SOURCE">Online Documentation</a>
 */
val SOURCE: ShowPortCandidates
/**
 * Show port candidates for possible ends of the newly created edge.
 * 
 * Value - `2`
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/ShowPortCandidates%23TARGET">Online Documentation</a>
 */
val TARGET: ShowPortCandidates
/**
