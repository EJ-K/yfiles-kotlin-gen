 ...
 */
external interface IReshapeHandler  {
  /**
   ...
   * @param [originalBounds] The value of the coordinates of the [bounds][IReshapeHandler] property at the time of [initializeReshape][IReshapeHandler].
   ...
   * @param [context] The context to retrieve information about the reshaping from.
   * @param [originalBounds] The value of the [bounds][IReshapeHandler] property at the time of [initializeReshape][IReshapeHandler].
   * @param [newBounds] The coordinates of the bounds in the world coordinate system that the client wants the shape to be at. Depending on the implementation, the [bounds][IReshapeHandler] may or may not be modified to reflect the new value.
   ...
   * @param [context] The context to retrieve information about the drag from.
   * @param [originalBounds] The value of the coordinate of the [bounds][IReshapeHandler] property at the time of [initializeReshape][IReshapeHandler].
   * @param [newBounds] The coordinates of the bounds in the world coordinate system that the client wants the shape to be at. Depending on the implementation the [bounds][IReshapeHandler] may or may not be modified to reflect the new value. This is the same value as delivered in the last invocation of [handleReshape][IReshapeHandler].
