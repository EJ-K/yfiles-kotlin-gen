 ...
 * 
 * @constructor Create a new instance for a specific table instance that use the order specified by `tableRenderingOrder` to determine the order of the hit test results.
 * @param [table] The table to use
 * @param [tableRenderingOrder] The hit test order. This determines the order in which stripes are returned by [enumerateHits]
 ...
 */
external open class StripeHitTester  (
 table: ITable ,
final val tableRenderingOrder: TableRenderingOrder) : YObject {
 ...
 */
 final   fun enumerateHits( context: IInputModeContext ,
 location: Point ,
 node: INode ):IEnumerable<StripeSubregion>
