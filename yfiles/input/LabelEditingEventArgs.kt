...
/**
 * Event arguments for the [query-label-adding][EditLabelInputMode] and [query-label-editing][EditLabelInputMode] events, as well as the [IEditLabelHelper] interface.
...
final var label: ILabel?) : InputModeEventArgs {
  ...
  /**
   * Gets or sets the [layoutParameter][ILabel] of the label to add.
  ...
  /**
   * Gets or sets the [preferredSize][ILabel] of the label to add.
  ...
  /**
   * Gets or sets the [style][ILabel] of the label to add.
  ...
  /**
   * Gets or sets the [tag][yfiles.collections.ITagOwner] of the label to add.
   ...
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/LabelEditingEventArgs%23text">Online Documentation</a>
   */
