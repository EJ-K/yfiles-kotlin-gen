 ...
 */
external interface IReparentStripeHandler : YObject {
/**
 ...
 */
   fun isValidParent( context: IInputModeContext ,
 stripe: IStripe ,
 newParent: IStripe ,
 index: Int ,
 ...
 */
   fun reparent( context: IInputModeContext ,
 movedStripe: IStripe ,
 newParent: IStripe ,
 index: Int ,
 ...
 */
   fun shouldReparent( context: IInputModeContext ,
