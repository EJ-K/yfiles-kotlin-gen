 ...
 */
external open class ReparentStripeHandler  () : IReparentStripeHandler {
 ...
 */
 open protected   fun adjustSize( context: IInputModeContext ,
 stripe: IStripe ,
 newParent: IStripe ,
 ...
 * @param [stripe] The stripe that will be reparented.
 * @param [newParent] The potential new parent.
 * @param [index] The index where the stripe would be [reparented][reparent]
 * @param [reparentPosition] Where to place the stripe as a result of the gesture that would be used for the [reparent] operation.
 * @return `true` iff the resulting nesting depth is smaller than [maxRowLevel] or [maxColumnLevel], or if the nesting depth would not increase by the operation.
 ...
 */
 ...
 newParent: IStripe ,
 index: Int ,
 reparentPosition: StripeReparentPolicy ):Boolean
/**
