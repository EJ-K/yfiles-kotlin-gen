...
/**
 * Flaggable enumeration used by [MoveViewportInputMode.inertia] to determine when to use inertia moving.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/InertiaPolicies">Online Documentation</a>
 */
external class InertiaPolicies 
    private constructor(): YFlags<InertiaPolicies> {
    companion object {
    /**
