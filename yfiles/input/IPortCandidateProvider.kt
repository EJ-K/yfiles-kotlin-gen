 ...
 * @see [NodeDecorator.portCandidateProviderDecorator][yfiles.graph.NodeDecorator.portCandidateProviderDecorator]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IPortCandidateProvider">Online Documentation</a>
 */
external interface IPortCandidateProvider : YObject {
/**
 ...
 */
   fun getAllSourcePortCandidates( context: IInputModeContext ):IEnumerable<IPortCandidate>
/**
 ...
 */
   fun getAllTargetPortCandidates( context: IInputModeContext ):IEnumerable<IPortCandidate>
/**
 ...
 */
   fun getSourcePortCandidates( context: IInputModeContext ,
 ...
 */
   fun getTargetPortCandidates( context: IInputModeContext ,
 ...
 */
@JsName("combine")
  operator fun invoke( providers: IEnumerable<IPortCandidateProvider> ):IPortCandidateProvider
/**
 * Creates a generic composite implementation for the [IPortCandidateProvider] interface.
 * @param [providers] The providers to create the composite from.
 ...
 */
@JsName("combine")
  operator fun invoke(vararg  providers: IPortCandidateProvider ):IPortCandidateProvider
/**
 ...
 * @return A new [IPortCandidateProvider].
 ...
 */
   fun fromCandidates(vararg  candidates: IPortCandidate ):PortCandidateProviderBase
/**
 * Creates an implementation of an [IPortCandidateProvider] that provides only the given port candidates.
 * @param [candidates] The port candidates the provider should provide.
 * @return A new [IPortCandidateProvider].
 ...
 */
   fun fromCandidates( candidates: IEnumerable<IPortCandidate> ):PortCandidateProviderBase
/**
 * Creates an implementation of the [IPortCandidateProvider] interface that returns the ports that exist in the given [IPortOwner.ports]'s [IPortOwner] collection.
 ...
 */
   fun fromExistingPorts( owner: IPortOwner ):IPortCandidateProvider
/**
 * Creates a trivial implementation of an [IPortCandidateProvider] that always returns exactly one candidate that is centered at the node's [INode.layout].
 ...
 */
   fun fromNodeCenter( node: INode ):PortCandidateProviderBase
/**
 * Creates an implementation of an [IPortCandidateProvider] that always returns a candidate that uses the default [IPortDefaults.locationParameter][yfiles.graph.IPortDefaults.locationParameter] for the corresponding [IPortDefaults][yfiles.graph.IPortDefaults].
 ...
 */
   fun fromPortDefaults( owner: IPortOwner ):IPortCandidateProvider
/**
 ...
 */
   fun fromShapeGeometry( owner: IPortOwner ,
vararg  ratios: Double ):PortCandidateProviderBase
/**
 * Creates an implementation of [IPortCandidateProvider] that works for [IPortOwner] implementations that have [IShapeGeometry][yfiles.styles.IShapeGeometry] instances in their lookup.
 * @param [owner] The owner to receive the shape geometry from
 * @param [addExistingPortsEnabled] determines whether [existing ports should be added to the list of ports][PortCandidateProviderBase.addExistingPorts].
 ...
 */
   fun fromUnoccupiedPorts( owner: IPortOwner ):IPortCandidateProvider
}
}
