...
/**
 * Interface for a handle that can be displayed in a [CanvasComponent][yfiles.view.CanvasComponent] as a UI element for the user to modify the contents of the [CanvasComponent][yfiles.view.CanvasComponent].
 * @see [HandleInputMode]
 * @see [IDragHandler]
...
external interface IHandle : IDragHandler {
   ...
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IHandle%23tag">Online Documentation</a>
   */
  val tag: Tag?
  ...
  /**
   * Called to indicate that the handle has been [clicked or tapped][yfiles.view.PointerEventType] by the user.
