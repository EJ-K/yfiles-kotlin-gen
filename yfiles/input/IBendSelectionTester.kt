 ...
 */
external interface IBendSelectionTester  {
  /**
   ...
   * @return The bends inside of `lassoPath`.
   * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IBendSelectionTester%23IBendSelectionTester-method-getBendsInPath">Online Documentation</a>
   */
  fun getBendsInPath(
    context: IInputModeContext,
