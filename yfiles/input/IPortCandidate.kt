 ...
 * @throws NotSupportedError If the [validity] is [PortCandidateValidity.DYNAMIC].
 ...
 */
   fun createPort( context: IInputModeContext ):IPort
/**
 ...
 */
   fun getPortCandidateAt( context: IInputModeContext ,
