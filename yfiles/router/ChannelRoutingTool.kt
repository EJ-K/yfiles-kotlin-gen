 ...
 * @param [orientation] The orientation of the channel. If omitted, the default value is [ChannelOrientation.HORIZONTAL].
 ...
 */
external open class ChannelRoutingTool  ( min: Double ,
 max: Double ,
 orientation: ChannelOrientation  = definedExternally) : YObject {
 ...
 */
open var ignoreEpsilonChannel: Boolean
/**
 ...
 */
 open   fun addGroupSegment( key: Id ,
 groupId: Id ,
 p1: YPoint ,
 p2: YPoint )
/**
 ...
 */
 open   fun addSegment( key: Id ,
 p1: YPoint ,
 p2: YPoint )
/**
 * Returns whether the given id has already been registered as a group id.
 * @param [groupId] the group id used during [adding][addGroupSegment]
 ...
 */
 open   fun containsGroupKey( groupId: Id ):Boolean
/**
 * Returns whether the given key has already been registered.
 * @param [key] the key used during [adding][addSegment]
 * @return `true` if the key has already been registered, `false` otherwise
 ...
 */
 open   fun containsKey( key: Id ):Boolean
/**
 * Returns the calculated channel coordinate for an added edge object.
 * @param [key] the key used during [adding][addSegment] the edge object
 ...
 */
 open   fun getChannelCoordinate( key: Id ):Double
/**
 * Returns the sub-channel rank for the specified edge group within the channel.
 * @param [groupId] the group id used during [adding][addGroupSegment] an edge object
 ...
 */
 open   fun getGroupSubchannelRank( groupId: Id ):Double
/**
 ...
 */
 open   fun getSubchannelRank( key: Id ):Double
/**
 ...
 */
 open   fun setChannel( min: Double ,
 max: Double ,
