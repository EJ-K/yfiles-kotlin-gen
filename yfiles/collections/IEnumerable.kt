 ...
 */
external interface IEnumerable<out T> : YObject {
/**
 ...
 */
  final  fun append(vararg  items: @UnsafeVariance T ):IEnumerable<T> = definedExternally
/**
 ...
 * @return The element at the given `index`, or `undefined` if the index is not within the range of this enumerable.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-at">Online Documentation</a>
 */
  final  fun at( index: Int ):T? = definedExternally
/**
 * Concatenates this enumerable with the given other `elements` in a new dynamic [IEnumerable].
 * @param [elements] Rest arguments to be appended. In case the elements are enumerable-like, too, they will be will be enumerated after the others have been enumerated. But this can also be simple objects of type `T` in which case they will be appended to the enumerable just like with [append]
 ...
 */
  final  fun concat(vararg  elements: IEnumerable<@UnsafeVariance T> ):IEnumerable<T> = definedExternally
/**
 ...
 */
  final  fun distinct( keySelector: ShortKeySelector<T, Any>?  = definedExternally):IEnumerable<T> = definedExternally
/**
 * Returns the element at the given `index` in this enumerable.
 * @param [index] The index of the element to return.
 * @return The element at the given `index`.
 * @throws ArgumentError If the `index` is not within the range of this enumerable.
 * @see [at]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-elementAt">Online Documentation</a>
 */
@Deprecated("Read documentation for more information")
  final  fun elementAt( index: Int ):T = definedExternally
/**
 ...
 */
  final  fun every( predicate: ElementPredicate<T> ):Boolean = definedExternally
/**
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-filter">Online Documentation</a>
 */
  final  fun filter( predicate: ElementPredicate<T> ):IEnumerable<T> = definedExternally
/**
 * Returns the first element of this enumerable, the first element of the enumerable that matches a given `predicate` if specified, or `null` if there is no such element.
 * @param [predicate] A predicate function which returns `true` if the given element should be returned.
 * @return The first element of this enumerable, its first element that matches a given predicate, or `null` if there is no such element.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-find">Online Documentation</a>
 */
  final  fun find( predicate: ElementPredicate<T>?  = definedExternally):T? = definedExternally
/**
 ...
 */
  final  fun findIndex( predicate: ElementPredicate<T> ):Int = definedExternally
/**
 * Returns the last element of this enumerable, the last element of the enumerable that matches a given `predicate` if specified, or `null` if there is no such element.
 * @param [predicate] A predicate function which returns `true` if the given element should be returned.
 * @return The last element of this enumerable, its last element that matches a given predicate, or `null` if there is no such element.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-findLast">Online Documentation</a>
 */
  final  fun findLast( predicate: ElementPredicate<T>?  = definedExternally):T? = definedExternally
/**
 ...
 */
  final  fun findLastIndex( predicate: ElementPredicate<T> ):Int = definedExternally
/**
 * Returns the first element of this enumerable or the first element of this enumerable that matches a given `predicate`, if specified.
 * @param [predicate] A function which returns `true` if the given element should be returned.
 * @return The first matching element of this enumerable.
 * @throws InvalidOperationError If this enumerable does not contain a matching element.
 * @see [find]
 * @see [findLast]
 * @see [at]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-first">Online Documentation</a>
 */
  final  fun first( predicate: ElementPredicate<T>?  = definedExternally):T = definedExternally
/**
 * Returns the first element of this enumerable, the first element of this enumerable that matches a given `predicate`, if specified, or `null` if there is no such element.
 * @param [predicate] A predicate function which returns `true` if the given element should be returned.
 * @return The first element of this enumerable, its first element that matches a given predicate, or `null` if there is no such element.
 * @see [find]
 * @see [findLast]
 * @see [at]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-firstOrDefault">Online Documentation</a>
 */
@Deprecated("Read documentation for more information")
  final  fun firstOrDefault( predicate: ElementPredicate<T>?  = definedExternally):T? = definedExternally
/**
 ...
 */
  final  fun <TResult>flatMap( selector: FlatMapSelector<T, TResult> ):IEnumerable<TResult> = definedExternally
/**
 ...
 */
  final  fun forEach( action: ElementAction<T> ):Unit = definedExternally
/**
 ...
 */
  final  fun <TKey, TResult>groupBy( keySelector: KeySelector<T, TKey> ,
 resultCreator: ResultCreator<T, TKey, TResult>?  = definedExternally):IEnumerable<TResult> = definedExternally
/**
 ...
 */
  final  fun includes( item: @UnsafeVariance T ):Boolean = definedExternally
/**
 ...
 */
  final  fun indexOf( item: @UnsafeVariance T ):Int = definedExternally
/**
 * Returns the last element of this enumerable or the last element of this enumerable that matches a given `predicate`, if specified.
 * @param [predicate] A function which returns `true` if the given element should be returned.
 * @return The last element of this enumerable.
 * @throws InvalidOperationError If the enumerable is empty.
 * @see [find]
 * @see [findLast]
 * @see [at]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-last">Online Documentation</a>
 */
  final  fun last( predicate: ElementPredicate<T>?  = definedExternally):T = definedExternally
/**
 * Returns the last element of this enumerable, the last element of this enumerable that matches a given `predicate`, if specified, or `null` if there is no such element.
 * @param [predicate] A predicate function which returns `true` if the given element should be returned.
 * @return The last element of the enumerable or `null`.
 * @see [find]
 * @see [findLast]
 * @see [at]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-lastOrDefault">Online Documentation</a>
 */
@Deprecated("Read documentation for more information")
  final  fun lastOrDefault( predicate: ElementPredicate<T>?  = definedExternally):T? = definedExternally
/**
 ...
 */
  final  fun <TResult>map( selector: Selector<T, TResult> ):IEnumerable<TResult> = definedExternally
/**
 * Converts this untyped enumerable into an enumerable with the given type.
 * @return A typed enumerable.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-ofType">Online Documentation</a>
 */
  final  fun <TResult : YObject>ofType( resultType: YClass<TResult> ):IEnumerable<TResult> = definedExternally
/**
 * Yields an ordered enumerable of the elements given a key selection function and optional comparison function and creates a ordered view of the enumerable.
 * @param [keySelector] The function that determines the key for sorting the elements. If omitted, the element itself is used.
 * @param [comparer] A function with the signature `function(key1, key2):Number` which is used for the sort operation to compare the key elements in the enumerable. May be omitted.
 * @return An enumeration of groups of the original enumerable.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-orderBy">Online Documentation</a>
 */
  final  fun <TKey>orderBy( keySelector: ShortKeySelector<T, TKey>?  = definedExternally,
 comparer: ElementComparison<TKey>?  = definedExternally):IEnumerable<T> = definedExternally
/**
 * Yields an ordered enumerable of the elements given a key selection function and optional comparison function and creates a ordered view of the enumerable where the elements are yielded in descending order.
 * @param [keySelector] The function that determines the key for sorting the elements. If omitted, the element itself is used.
 * @param [comparer] A function with the signature `function(key1, key2):Number` which is used for the sort operation to compare the key elements in the enumerable. May be omitted.
 * @return An enumeration of groups of the original enumerable.
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-orderByDescending">Online Documentation</a>
 */
  final  fun <TKey>orderByDescending( keySelector: ShortKeySelector<T, TKey>?  = definedExternally,
 comparer: ElementComparison<TKey>?  = definedExternally):IEnumerable<T> = definedExternally
/**
 ...
 */
  final  fun prepend(vararg  items: @UnsafeVariance T ):IEnumerable<T> = definedExternally
/**
 ...
 */
  final  fun reduce( accumulator: Accumulator<T, @UnsafeVariance T> ):T = definedExternally
/**
 * Applies the `accumulator` function to this elements of this enumerable.
 * @param [TAccumulate] The type of the accumulated value.
 * @param [accumulator] A function which "adds" (accumulates) a value depending on the element and index to the initial value and returns the result.
 * @param [initialValue] The initial value for the accumulator. Omit/use the [reduce] overload if you don't want to specify an initial value.
 * @return The result of the accumulation.
 * @see [reduceRight]
 ...
 */
  final  fun <TAccumulate>reduce( accumulator: Accumulator<T, TAccumulate> ,
 initialValue: TAccumulate? ):TAccumulate = definedExternally
/**
 ...
 */
  final  fun reduceRight( accumulator: Accumulator<T, @UnsafeVariance T> ):T = definedExternally
/**
 * Applies the `accumulator` function to this elements of this enumerable in reverse order.
 * @param [TAccumulate] The type of the accumulated value.
 * @param [accumulator] A function which "adds" (accumulates) a value depending on the element and index to the seed value and returns the result.
 * @param [initialValue] The initial value for the accumulator. Omit/use the [reduceRight] overload if you don't want to specify an initial value.
 ...
 */
  final  fun <TAccumulate>reduceRight( accumulator: Accumulator<T, TAccumulate> ,
 initialValue: TAccumulate? ):TAccumulate = definedExternally
/**
 * Creates a wrapped view of an enumerable which skips the given amount of elements.
 * @param [amount] The number of elements to skip at the beginning.
 * @return A new live view over the original enumerable that skips `amount` elements.
 * @see [skipWhile]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-skip">Online Documentation</a>
 */
  final  fun skip( amount: Int ):IEnumerable<T> = definedExternally
/**
 ...
 * @see [take]
 * @see [takeWhile]
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-skipWhile">Online Documentation</a>
 */
  final  fun skipWhile( predicate: ElementPredicate<T> ):IEnumerable<T> = definedExternally
/**
 ...
 */
  final  fun some( predicate: ElementPredicate<T>?  = definedExternally):Boolean = definedExternally
/**
 ...
 */
  final  fun sum( selector: Selector<T, Int> ):Double = definedExternally
/**
 ...
 */
  final  fun take( count: Int ):IEnumerable<T> = definedExternally
/**
 ...
 */
  final  fun takeWhile( predicate: ElementPredicate<T> ):IEnumerable<T> = definedExternally
/**
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-elementAt">Online Documentation</a>
 */
inline operator fun <T> IEnumerable<T>.get( index: Int ):T {
    return  asDynamic().elementAt(index)
}
/**
 * Determines whether the given value is part of this enumerable.
 * @param [item] The value to search for.
 ...
 * @see <a href="https://docs.yworks.com/yfileshtml/#/api/IEnumerable%23IEnumerable-defaultmethod-includes">Online Documentation</a>
 */
inline operator fun <T> IEnumerable<T>.contains( item: T ):Boolean {
